...
gulp.task('scripts-ie', function() {
  return gulp.src([ // Берем все необходимые библиотеки для обеспечения совместимости со старыми браузерами
      'node_modules/es5-shim/es5-shim.js', // es5-shim
      'node_modules/es5-shim/es5-sham.js', // es5-sham
      'node_modules/html5shiv/dist/html5shiv.js', // html5shiv
      'node_modules/html5shiv/dist/html5shiv-printshiv.js', // html5shiv-printshiv
      'node_modules/respond.js/dest/respond.src.js', // Respond.js
    ])
    .pipe(sourcemaps.init())
    .pipe(debug({title: '| scripts > src:'}))
    .pipe(concat('libs-ie.js')) // Собираем их вместе в новом файле libs.js
